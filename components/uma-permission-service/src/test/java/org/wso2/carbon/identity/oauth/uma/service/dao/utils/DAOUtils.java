...
public class DAOUtils {
    ...
    //    private static final String STORE_RESOURCE_QUERY = "INSERT INTO IDN_RESOURCE ( RESOURCE_ID, RESOURCE_NAME, " +
//            "TIME_CREATED, RESOURCE_OWNER_ID, TENANT_ID) VALUES (?,?,?,?,?)";
    private static final String STORE_OAUTH2SCOPE_QUERY = "INSERT INTO IDN_OAUTH2_SCOPE (SCOPE_ID, NAME, DESCRIPTION)" +
            " VALUES (?,?,?)";
    private static final String STORE_PT_QUERY = "INSERT INTO IDN_PERMISSION_TICKET " +
            "(ID, PT, TIME_CREATED, VALIDITY_PERIOD, TICKET_STATE) VALUES (?,?,?,?,?)";
    ...
    protected void createOauth2ScopeTable(String databaseName, long scopeId, String name, String description)
            throws Exception {

        PreparedStatement preparedStatement = null;
        try (Connection connection = getConnection(databaseName)) {
            preparedStatement = connection.prepareStatement(STORE_OAUTH2SCOPE_QUERY);
            preparedStatement.setLong(1, scopeId);
