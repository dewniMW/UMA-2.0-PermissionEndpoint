...
public class PermissionApi  {
   ...
   private final PermissionApiService delegate = PermissionApiServiceFactory.getPermissionApi();
    ...
    public Response requestPermission(@ApiParam(value = "Protection API Access Token." ,required=true )@HeaderParam("PAT") String PAT,
    @ApiParam(value = "The requested permissions."  ) ResourceModelDTO requestedPermission)
    {
    return delegate.requestPermission(PAT,requestedPermission);
    }
}
